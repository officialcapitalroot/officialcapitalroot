...
export default function Header() {
  ...
  return (
    <header className={`header ${isScrolled ? 'scrolled' : ''}`} itemScope itemType="https://schema.org/WPHeader">
      <div className="container">
        <nav className="nav" itemScope itemType="https://schema.org/SiteNavigationElement">
         ...
         <div id="nav-links" className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <Link href="/videos" onClick={closeMenu} itemProp="url">
              <span itemProp="name">Videos</span>
            </Link>
            <Link href="/about" onClick={closeMenu} itemProp="url">
