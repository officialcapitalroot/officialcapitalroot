...
//   // FIXED: Only enforce HTTPS in production, not on localhost
//   useEffect(() => {
//     setIsClient(true);
    
//     // Only force HTTPS in production, not on localhost
//     if (typeof window !== 'undefined' && 
...
//     setLoadingSeason(true);
//     try {
//       // FIXED: Use relative URL for API calls to work on both localhost and production
//       const response = await fetch(`/api/tv-season?tvId=${media.id}&season=${seasonNumber}`);
//       const data = await response.json();
//       setSeasonData(data);
//       if (data && data.episodes) {
...
//   // FIXED: Smart canonical URL that works on both localhost and production
//   const getCanonicalUrl = () => {
//     if (typeof window !== 'undefined') {
//       return window.location.href;
//     }
...
//   // FIXED: Smart URL handling for both environments
//   const getThumbnailUrl = () => {
//     if (isTMDB) {
//       if (media.poster_path || media.backdrop_path) {
//         return getImageUrl(media.poster_path || media.backdrop_path, "w500");
//       }
//       // Use relative path for default image
//       return "/default-thumbnail.jpg";
//     } else {
//       if (!video.thumbnail) {
//         return "/default-thumbnail.jpg";
...
//   // FIXED: Use proper URLs based on environment
//   const baseUrl = process.env.NODE_ENV === 'production' 
//     ? 'https://capitalroot.vercel.app' 
//     : 'http://localhost:3000';
...
//         "position": 2,
//         "name": mediaType === 'tv' ? "TV Shows" : "Movies",
//         "item": `${baseUrl}/${mediaType === 'tv' ? 'tv' : 'videos'}`,
//       },
//       {
//         "@type": "ListItem",
//         "position": 3,
